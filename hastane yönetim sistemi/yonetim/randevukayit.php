...
<head>
     ...
     <title>Eren HASTANESİ - RANDEVU KAYDI</title>
...
.iletisimbutonu:active {
    ...
    <script type="text/javascript">
        $("#btnPrint").live("click", function () {
            ...
            printWindow.document.write('<html><head><title>Eren Hastanesi | Randevuyu Yazdır</title>');
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-8 col-sm-7 text-align-right">
                         ...
                         <span class="email-icon"><i class="fa fa-envelope-o"></i> <a href="../#">iletisim@erenhastanesi.com</a></span>
                    </div>
     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="../index.html" class="navbar-brand"><i class="fa fa-stethoscope"></i> Eren Hastanesi</a>
               </div>
...
<h2>Sn. ' . $adsoyad . ' Randevunuz Başarıyla Alındı</h2>
 ...
 <div id="dvContainer">
<center>
<p>Eren Hastanesi Randevu Bilgileriniz</p>
